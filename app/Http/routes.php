...
// Cargar Nombre de rutas en Combobox
Route::any('Consultar_Rutas_Empleado', array('as'=>'Consultar_Rutas_Empleado','uses'=>'Controller_Formulario\FormularioController@Consultar_Rutas_Empleado'))->middleware('auth');
// Termina de Cargar Nombre de Rutas en Combobox
...
Route::any('Consultar_Turno', array('as'=>'Consultar_Turno','uses'=>'Controller_Formulario\FormularioController@Consultar_Turno'))->middleware('auth');



// Ruta Cargar Vista Turno
Route::any('CargarVistaTurnos', array('as'=>'CargarVistaTurnos','uses'=>'AdministradorController\Administrador_Controller@CargarVistaTurnos'))->middleware('auth');

// Ruta Cargar Turnos Tabla
Route::any('Cargar_Tabla_Turnos', array('as'=>'Cargar_Tabla_Turnos','uses'=>'AdministradorController\Administrador_Controller@Cargar_Tabla_Turnos'))->middleware('auth');


//--------------------------------fin control consolidados---------------------------------
Route::any('Registrar_Nuevo_Turno', array('as'=>'Registrar_Nuevo_Turno','uses'=>'AdministradorController\Administrador_Controller@Registrar_Nuevo_Turno'))->middleware('auth');
