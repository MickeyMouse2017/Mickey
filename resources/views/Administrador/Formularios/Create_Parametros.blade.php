				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-12">
								<center>
									<button type="button" class="btn btn_nueva_unidad" id="btn_nueva_unidad" style="background: #124f0b">
										<strong>
											<font size ="2", color ="#ffffff" face="Lucida Sans">
												<span>Nuevo</span>
											</font>
...
<script type="text/javascript">
	...
	function Cambio_Estado_Botones(){
		var id_parametro_seleccionado= document.getElementById("id_parametro_seleccionado").value;
		var NombreVariable =$("#id_parametro_seleccionado option:selected").text().toUpperCase();
...
// $( '#ButtonPrueba' ).on( 'click', function() {
	...
	function Habilitar_Botones_Unidad(){
		...
		var NombreVariable =$("#id_parametro_seleccionado option:selected").text().toUpperCase();
		var NombreUnidad =$("#id_select_unidad option:selected").text().toUpperCase();
		var id_parametro_seleccionado= document.getElementById("id_parametro_seleccionado").value;
