	...
	<div class="row">                 
		<div class="col-lg-12">			
			<div class="table-responsive">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-bordered table-hover table-striped">
								...
								<tbody>
									@foreach ($Listar_Turnos as $value)	
									<tr>
										<td>									
											{{ucfirst($value->nombre_turno)}}																						
										</td>	
										<td>
											<center>
												<span class="badge btn-md btn-success" style="height: 25px;background-color: #0b62a0; color: #FFF">
													<b>
														<strong>
															<font size ="4">
																{{Carbon::parse($value->hora_inicio)->format('g:i A')}} 
															</font>
														</strong>
													</b>
												</span>	
											...
											<center>
												<span class="badge btn-md btn-success" style="height: 25px;background-color: #0b62a0; color: #FFF">
													<b>
														<strong>
															<font size ="4">
																{{Carbon::parse($value->hora_fin)->format('g:i A')}}
															</font>
														</strong>
													</b>
												</span>	
				...
				<center>{{$Listar_Turnos->links()}}</center>	
			</div>
			<div class="panel-footer">Total Registros: {{$Listar_Turnos->total()}}</div>
		</div>
	</div>
	@endif