...
<script type="text/javascript">
	...
	function CargarDatosCombobox(){
		...
		$.ajax({
			type:'get',
			url:'{{ url('Consultar_Rutas_Empleado')}}',
			success: function(data){
				$('#TipoMensaje').html('<center>HOLA, '+'{{Auth::user()->nombre_usuario}} {{Auth::user()->apellido}}, '+data.MensajeVista+'</center>');
