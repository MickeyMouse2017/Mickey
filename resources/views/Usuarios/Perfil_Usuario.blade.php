				...
				function Obtener_Imagen(input) {
					...
					if (input.files && input.files[0]) {
						...
						reader.onload = function (e) {
							...
							// $("#FotoUsuarioPerfil").css("height","auto");	
							// $("#FotoUsuarioPerfil").css("margin","20px");	
							// $("#FotoUsuarioPerfil").css("padding","10px");	
							// $("#FotoUsuarioPerfil").css("border","1px solid #000");	

							// $("#FotoUsuarioPerfil").css({"height": "auto",     "margin": "20px","padding":"10px","border":"1px solid #000"});
					...
					$.ajax({
						...
						success:function(respuesta){
							if(respuesta==0){  
								...
								$("#estilo_mensaje5").fadeTo(60000, 500).slideUp(500, function(){
									$("#estilo_mensaje5").hide();	
