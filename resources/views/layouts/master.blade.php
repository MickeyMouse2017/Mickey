...
<head>
	<meta charset="utf-8"/>
	<title>@yield('title') | TpmMovil APP</title>
...
Variable_Tiempo = setTimeout('document.location.href = "{{ route('Salir')}}"',1);
return  ;
}
}
}
...
<body class="page-md page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed-mobile page-footer-fixed1" onload="deshabilitaRetroceso();Consultar_Notificaciones_Cada_5_Min();startTime();@if(Auth::user()->fk_rol!=1) ini();@endif" onkeypress="CancelarContador()" onclick="CancelarContador()">
	<!-- BEGIN HEADER -->
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					else if ($vista == '' || $vista == 'CargarVistaTurnos'){
						$current['CargarVistaTurnos'] = 'active';
					}														
					?>
					@if(Auth::user()->fk_rol!=1)
					...
					<li class="{{$current['ReportarDano']}}">
						...
						@if(Auth::user()->fk_rol==1)
						<!-- Asignaciones -->
						<li class="{{$current['Asignaciones']}}">
							<a href="{{URL::route('Asignaciones')}}">
						...
						<!-- Notificaciones -->
						<li class="{{$current['Equipos']}}">
							<a href="{{URL::route('Equipos')}}">
						...
						<li class="{{$current['EdicionFormulario']}}">
							<a href="{{URL::route('EdicionFormulario')}}">
						...
						<li class="{{$current['control_consolidado']}}">
							<a href="{{URL::route('control_consolidado')}}">
						...
						<li class="{{$current['Reports']}}">
							...
							<ul class="sub-menu">
								<li>
									<a href="{{URL::route('Reporte_Maquinas')}}">
							...
							<!-- Empieza Turnos -->
							<li class="{{$current['CargarVistaTurnos']}}">
								<a href="{{URL::route('CargarVistaTurnos')}}">
				...
				<script type="text/javascript">
					...
					function Autocompletado_rutas(){
						...
						window.setTimeout(function(){NotificacionesMensajes();},3000);
					}					
