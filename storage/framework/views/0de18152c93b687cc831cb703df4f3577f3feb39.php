	...
	<div class="panel-body">
		<div  class="row" >
			<div class="col-md-3">				
				...
				<select class="form-control selectpicker id_formulario" onchange="CambioEstado();Vaciar_Parametros();" data-live-search="true" id="id_formulario" name="id_formulario"  autofocus>
					<option></option>
				</select>
			</div>
			<div class="col-md-3">
...
<script type="text/javascript">
	...
	function Vaciar_Parametros(){
		// RemoverDataCombobox(document.getElementById("ParametroControl"));
		// Parametros();
