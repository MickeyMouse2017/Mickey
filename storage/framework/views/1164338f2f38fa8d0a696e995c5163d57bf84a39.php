		...
		<div class="portlet-body">
			<div class="panel panel-success">
				...
				<div class="panel-body">					
					...
					<div class="col-sm-4">
						<input type="text" name="" class="form-control" value="<?php echo e(strtoupper($NombreEquipo)); ?>" readonly>
					</div>				
					<div class="col-sm-2">
					...
					<div class="col-sm-4">
						<input type="text" name="" class="form-control" value="<?php echo e(strtoupper($Nombre_Turno)); ?>" readonly>
					</div>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							<td>
								<strong>
									<font size ="3", color ="#243c98" face="Lucida Sans"><?php echo e($parametros_control=strtoupper($value->NombreParametro->nombre_parametro)); ?>
							...
							<td>
								<strong>
									<font size ="3", color ="#243c98" face="Lucida Sans">
										<?php echo e($parametros_control=strtoupper($value->NombreUnidad->nombre_unidad)); ?>
