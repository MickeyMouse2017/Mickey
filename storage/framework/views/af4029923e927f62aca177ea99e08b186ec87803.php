								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e($value->Nombre_Turno->nombre_turno); ?> (<?php echo e(Carbon::parse($value->Nombre_Turno->hora_inicio)->format('g:i A')); ?> - <?php echo e(Carbon::parse($value->Nombre_Turno->hora_fin)->format('g:i A')); ?>)
