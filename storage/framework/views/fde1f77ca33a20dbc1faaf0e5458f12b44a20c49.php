	...
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
				<div class="panel panel-danger">
					...
					<div class="panel-body">			
						<div class="form-group ">				
							<font size ="3", color ="#243c98" face="Eras Light ITC">
								<strong>Seleccione la RUTA a mostrar:</strong>
							</font>
					...
					<strong><font size ="2", color ="#ffffff" face="Lucida Sans"><span>NUEVA RUTA</span></font></strong>
					<font color ="#ffffff">
						<span class="fa fa-plus-square"></span>
					</font>
				</button>
				...
				<strong><font size ="2", color ="#ffffff" face="Lucida Sans"><span>EDITAR RUTA</span></font></strong>
				<font color ="#ffffff">
					<span class="fa fa-pencil-square-o"></span>
				</font>
			</button>
			<button type="button" class="btn Cancelar" style="display: none;background-color: #82000d" 
			id="CancelarFormulario" title="Editar Formulario">
			...
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">
					<b><strong> <font size ="2", color="#007835" face="Arial Black">
						<i class="fa fa-file-o fa-2x" aria-hidden="true"></i> NUEVA RUTA</font></strong>						
					</b>
				</h4>
			</div>
				...
				<table class="table table-user-information">
					<div class="row">						
						<tbody>	
							...
							<tr>
								<td>								
									<b><strong><font size ="2", color="#000000" face="Tahoma">Seleccione el equipo:</font></strong></b>
								</td>
								<td>
							...
							<tr>
								<td>								
									<b><strong><font size ="2", color="#000000" face="Tahoma">Nombre RUTA:</font></strong></b>
								</td>
								<td>
...
<div class="modal fade" id="ModalConfirmar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">					
				<h4 class="modal-title" id="myModalLabel">¿ Esta seguro de Crear la nueva RUTA ?</h4>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">
					<b><strong> <font size ="2", color="#007835" face="Arial Black">
						<i class="fa fa-file-o fa-2x" aria-hidden="true"></i> REGISTROS DETALLES RUTAS</font></strong>						
					</b>
				</h4>
			</div>
			<div class="modal-body">
						...
						<tbody>	
							...
							<tr>
								<td>
									...
									<b><strong><font size ="2", color="#000000" face="Tahoma">Parámetros Control:</font></strong></b>
								</td>
								<td>
							...
							<tr>
								<td>
									<i class="fa fa-cogs" aria-hidden="true"></i> 							
									<b><strong><font size ="2", color="#000000" face="Tahoma">Unidad:</font></strong></b>
								</td>
								<td>
							...
							<tr>
								<td>
									<i class="fa fa-cogs" aria-hidden="true"></i> 							
									<b><strong><font size ="2", color="#000000" face="Tahoma">Valor Mínimo</font></strong></b>
								</td>
								<td>
							...
							<tr>
								<td>
									<i class="fa fa-cogs" aria-hidden="true"></i> 							
									<b><strong><font size ="2", color="#000000" face="Tahoma">Valor Ideal:</font></strong></b>
								</td>
								<td>
							...
							<tr>
								<td>	
									<i class="fa fa-cogs" aria-hidden="true"></i> 						
									<b><strong><font size ="2", color="#000000" face="Tahoma">Valor Máximo</font></strong></b>
								</td>
								<td>
...
<div class="modal fade" id="ModalConfirmar_Detalle_Registro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">					
				<h4 class="modal-title" id="myModalLabel">
					¿ Está seguro de asignarle el parámetro a la RUTA ?</h4>
					<input type="hidden" name="IdNotificacion" id="IdNoti" class="form-control">
				</div>					
				<div class="modal-footer">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">					
					<h4 class="modal-title" id="myModalLabel">
						<b><strong> <font size ="2", color="#007835" face="Arial Black">
							<i class="fa fa-trash-o fa-2x" aria-hidden="true"></i> ¿ Está seguro de remover el parámetro de la RUTA seleccionada ?</font></strong>						
						</b>
					</h4>
	...
	<div class="modal fade" id="Modal_Editar_Registro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
					...
					<h4 class="modal-title" id="myModalLabel">
						<center>
							<b><strong> <font size ="3", color="#007835" face="Arial Black">
								<i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i> MODIFICAR PARÁMETRO RUTA</font></strong>					
							</b>
						</center>
					</h4>				
				</div>
								...
								<tbody>	
									...
									<tr>
										<td>
											...
											<b><strong><font size ="2", color="#000000" face="Tahoma">
		...
		<div class="modal fade" id="Modal_Confirmar_Editar_Registro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">					
						<h4 class="modal-title" id="myModalLabel">¿ Está seguro de editar el parámetro a la RUTA ?.					
						</h4>
					</div>					
					<div class="modal-footer">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel">
							<b><strong> <font size ="2", color="#007835" face="Arial Black">
								<i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i> EDITAR RUTA</font></strong>						
							</b>
						</h4>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade" id="Modal_Confirmar_Editar_Encabezado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">				
						<h4 class="modal-title" id="myModalLabel">¿ Está seguro de editar la RUTA ?</h4>
					</div>					
					<div class="modal-footer">				
		...
		<div class="modal fade" id="Modal_Confirmar_Nueva_Version_Formulario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">				
						<h4 class="modal-title" id="myModalLabel">¿ Está seguro de Crear una nueva versión de la RUTA ?</h4>
					</div>
					<div class="modal-boy">
						<div class="row">					
...
$('.BtnRegistrarNuevoFormulario').click(function(){
	var Nombre_Nuevo_Formulario= $('#Nombre_Nuevo_Formulario').val().toLowerCase();
...
$('.BtnEditarFormularioEncabezado').click(function(){
	var id_nombre_equipo_editar= document.getElementById("id_nombre_equipo_editar").value;
	var Nombre_Formulario_Editar=$('#Nombre_Formulario_Editar').val().toLowerCase();
